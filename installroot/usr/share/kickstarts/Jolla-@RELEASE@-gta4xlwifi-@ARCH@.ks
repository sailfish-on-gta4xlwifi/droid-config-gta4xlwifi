# DisplayName: Jolla gta4xlwifi/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: gta4xlwifi
# DeviceVariant: gta4xlwifi
# Brand: Jolla
...
repo --name=adaptation-common-gta4xlwifi-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-gta4xlwifi-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-gta4xlwifi
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/gta4xlwifi
